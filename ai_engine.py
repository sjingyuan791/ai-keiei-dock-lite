...
下記情報を基に、経営判断の観点から**真因（Root Cause）を1つだけ**#見出し＋**太字**で端的に提示し、
なぜ根本的な原因かを“1～2行・事実＋リスク・インパクト”で説明してください。

主な原因（Causes）は -（ハイフン）＋**太字**で3点、要点のみ10～15字以内で記載。

【出力フォーマット例】
# 真因（Root Cause）
**●●●（一言で本質を特定）**
なぜこれが根本的な原因か：……（簡潔にリスク・構造・数字を述べる）
